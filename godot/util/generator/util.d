module godot.util.generator.util;

import godot.util.generator.classes;
...
class Type {
    ...
    string getEnumValueStr(string value) const {
        ...
        import godot.util.generator.enums;

        // global enums doesn't have parent
        auto parent = Type.get(godot.util.generator.enums.enumParent(godotType));
        if (!parent)
    ...
    static Type get(string godotName) {
        ...
        static import godot.util.generator.enums;

        if (ret.isEnum) {
            ret.enumParent = get(godot.util.generator.enums.enumParent(godotName));
            enums ~= ret;
        }
...
string escapeType(string t) {
    import godot.util.generator.enums : qualifyEnumName;
