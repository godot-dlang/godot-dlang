module godot.util.generator.methods;

import godot.util.tools.string;
import godot.util.generator.classes, godot.util.generator.enums, godot.util.generator.util;
        ...
        foreach (i, ref a; arguments) {
            if (a.type.acceptImplicit) {
                if (first)
                    ...
                    ret ~= ", ";
                ret ~= text(a.type.godotType, "Arg", i);
            }
        }
        if (has_varargs) {
            if (!first)
    ...
    string argsString() const {
        ...
        foreach (i, ref a; arguments) {
            if (i != 0)
                ret ~= ", ";
            if (a.type.acceptImplicit)
                ret ~= text(a.type.dCallParamPrefix,
                    a.type.godotType, "Arg", i);
            else
                ret ~= text(a.type.dCallParamPrefix, a.type.dType);
